...
public abstract class BaseLinerView {
    ...
    //最新数据表示
    public  LimitLine line=new LimitLine(1);
    ...
    private void setAxis() {
        ...
        yl.setAxisMaximum(maxValue); // 设置Y轴最大值为
    ...
    private void initData() {
        ...
        setDataStyle();
        line.enableDashedLine(1f,4f,0f);
        line_chart.getXAxis().addLimitLine(line);
    }
...
//        dataSet.setMode(LineDataSet.Mode.CUBIC_BEZIER);
    ...
    public void onUdata(int v) {
        ...
        line_chart.setData(lineData);
        line_chart.getXAxis().removeAllLimitLines();
        line =new LimitLine(i);
        line_chart.getXAxis().addLimitLine(line);
