...
public class GetFromServer {
    public ArrayList<DataMotion> getdatalist(){
        ...
        for(int i = 0; i < 30; i ++) {
            dataMotionArrayList.add(new DataMotion(0, 1681627570235L, 355L));
            dataMotionArrayList.add(new DataMotion(3, 1681628570303L, 208L));
            dataMotionArrayList.add(new DataMotion(6, 1681630570689L, 198L));
        }
